...
-- Run this in your Supabase SQL editor for project nhxpnfspawlibdpihuqp
...
CREATE POLICY "Users can upload images for own listings" ON listing_images
...
('Shoes', 'shoes', 'Footwear for all', 4),
('Bags', 'bags', 'Bags and luggage', 5),
('Accessories', 'accessories', 'Fashion accessories', 6);

-- Insert subcategories
INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'Dresses', 'dresses', id, 1 FROM categories WHERE slug = 'women';
INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'Tops', 'tops', id, 2 FROM categories WHERE slug = 'women';
INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'Bottoms', 'bottoms', id, 3 FROM categories WHERE slug = 'women';
INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'Outerwear', 'outerwear', id, 4 FROM categories WHERE slug = 'women';

INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'Shirts', 'shirts', id, 1 FROM categories WHERE slug = 'men';
INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'T-Shirts', 't-shirts', id, 2 FROM categories WHERE slug = 'men';
INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'Pants', 'pants', id, 3 FROM categories WHERE slug = 'men';
INSERT INTO categories (name, slug, parent_id, display_order) 
SELECT 'Jackets', 'jackets', id, 4 FROM categories WHERE slug = 'men';
